...
def add_note():
    ...
    save_button = ttk.Button(
        note_frame, text="Save", command=save_note, style="secondary.TButton"
    )
...
new_button = ttk.Button(root, text="New Note", command=add_note, style="inform.TButton")

new_button.pack(side=tk.LEFT, padx=10, pady=10)

delete_button = ttk.Button(
    root, text="Delete", command=delete_node, style="primary.TButton"
)
